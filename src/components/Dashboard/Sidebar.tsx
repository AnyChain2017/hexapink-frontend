...
import { PiDatabaseLight, PiDatabaseFill, PiPackage, PiPackageFill, PiBinoculars, PiBinocularsFill } from "react-icons/pi";
...
const Sidebar = () => {
  return (
    <div className="h-screen w-64 bg-white text-dark border-r border-light-gray3">
