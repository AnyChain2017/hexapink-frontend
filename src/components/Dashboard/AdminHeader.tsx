      ...
      <div className="flex items-center gap-8">
        {pathname.includes("/dashboard") && (
            <div className="flex justify-center items-center gap-4">
              <Link href="/admin/dashboard" className="rounded-full px-4 py-2 flex items-center gap-2 bg-dark-blue text-white">
                <PiPlusCircle className="text-2xl" /> <span>Create Table</span>
              </Link>
              <Link href="/admin/dashboard" className="rounded-full px-4 py-2 flex items-center gap-2 bg-white text-dark-blue border border-dark-blue">
