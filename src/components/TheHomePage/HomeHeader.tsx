...
const HomeHeader = () => {
  ...
  return (
    <div className="flex justify-around  items-center w-full lg:h-[130px] h-[100px] border-b-2 border-[#FFCCDD] gap-20">
      <div className="absolute top-0 left-0 -z-50   bg-[#fff5f8] opacity-50"></div>
      <div
